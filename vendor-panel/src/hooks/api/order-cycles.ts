...
export const useOrderCycles = (params?: {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await sdk.client.fetch("/admin/order-cycles", {
        query: params,
      })
...
export const useOrderCycle = (id: string) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await sdk.client.fetch("/admin/order-cycles/" + id)
...
export const useDeleteOrderCycle = () => {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      await sdk.client.fetch("/admin/order-cycles/" + id, {
        method: "DELETE",
      })
    },
    onSuccess: () => {
  ...
  return useMutation({
    mutationFn: async (input: AddProductInput) => {
      const response = await sdk.client.fetch(
        "/admin/order-cycles/" + orderCycleId + "/products",
        {
          method: "POST",
          body: input,
        }
  ...
  return useMutation({
    mutationFn: async (productId: string) => {
      await sdk.client.fetch(
        "/admin/order-cycles/" + orderCycleId + "/products/" + productId,
        {
          method: "DELETE",
        }
      )
