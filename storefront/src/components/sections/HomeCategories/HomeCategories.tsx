...
export const categories: { id: number; name: string; handle: string; description?: string }[] = [
  {
    ...
    description: "Shop creator storefronts",
  },
  {
    id: 2,
    name: "Pre-Order Drops",
    handle: "pre-order-drops",
    description: "Reserve limited-run releases",
  },
  {
    id: 3,
    name: "Subscriptions",
    handle: "subscriptions",
    description: "Recurring boxes and memberships",
  },
  {
    id: 4,
    name: "Wholesale",
  ...
  },
  {
    ...
    description: "Instant access to files",
  },
  {
    id: 6,
    name: "Services",
    handle: "services",
    description: "Book consulting and coaching",
  },
  {
    id: 7,
    name: "Local Pickup",
    handle: "local-pickup",
    description: "Nearby pickup options",
  },
  {
    id: 8,
    name: "Custom Orders",
    handle: "custom-orders",
    description: "Made-to-order requests",
  },
  {
    id: 9,
    name: "Partnerships",
  ...
  },
  {
    ...
    description: "Group sales and specials",
  },
]
