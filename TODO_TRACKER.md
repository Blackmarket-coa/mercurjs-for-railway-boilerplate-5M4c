...
| ⬜ | High | `routes/orders` | `admin-panel/src/routes/orders/order-create-claim/components/claim-create-form/claim-outbound-item.tsx` | 70 | // TODO: add max available inventory quantity if present |
...
| ⬜ | High | `routes/orders` | `admin-panel/src/routes/orders/order-create-edit/components/add-order-edit-items-table/add-order-edit-items-table.tsx` | 57 | // TODO: Check inventory here. Check if other validations needs to be made |
